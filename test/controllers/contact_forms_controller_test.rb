...
class ContactFormsControllerTest < ActionController::TestCase
  ...
  test "should create contact_form" do
    assert_difference('ContactForm.count') do
      post :create, contact_form: { content: @contact_form.content, email: @contact_form.email, name: @contact_form.name, phone: @contact_form.phone, subject: @contact_form.subject }
    end
  ...
  test "should update contact_form" do
    patch :update, id: @contact_form, contact_form: { content: @contact_form.content, email: @contact_form.email, name: @contact_form.name, phone: @contact_form.phone, subject: @contact_form.subject }
    assert_redirected_to contact_form_path(assigns(:contact_form))
  end
